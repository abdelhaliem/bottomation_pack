...
/// Optional controller to programmatically trigger or reset an [AnimatedDeleteButton].
class AnimatedDeleteButtonController extends ChangeNotifier {
  BottomationState _state = BottomationState.idle;

  /// Current state of the animated delete button.
  ...
  /// Programmatically triggers the deletion animation flow.
  void trigger() {
...
typedef BottomationController = AnimatedDeleteButtonController;
