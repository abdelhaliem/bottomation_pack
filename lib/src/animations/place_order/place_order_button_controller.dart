...
/// Optional controller to programmatically trigger or reset an [AnimatedPlaceOrderButton].
class AnimatedPlaceOrderButtonController extends ChangeNotifier {
  BottomationState _state = BottomationState.idle;

  /// Current state of the animated place-order button.
  ...
  /// Programmatically triggers the place-order animation flow.
  void trigger() {
