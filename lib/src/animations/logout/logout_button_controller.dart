...
/// Optional controller to programmatically trigger or reset an [AnimatedLogoutButton].
class AnimatedLogoutButtonController extends ChangeNotifier {
  BottomationState _state = BottomationState.idle;

  /// Current state of the animated logout button.
  ...
  /// Programmatically triggers the logout animation flow.
  void trigger() {
